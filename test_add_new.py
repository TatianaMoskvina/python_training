...
class AddNew(unittest.TestCase):
    ...
    def test_add_new(self):
        ...
        self.create_new_address(wd, FirstName="Fname", MidleName="Mname", LastName="Lname", NickName="NickName", Company="Ant", Address="123", Home="123", Mobile="123", Work="1234", Fax="12345",
                                Email="a@a.com")
        self.submit(wd)
        self.logout(wd)
    ...
    def create_new_address(self, wd, FirstName, MidleName, LastName, NickName, Company, Address, Home, Mobile, Work, Fax,
                           Email):
